...
import { ChartBarIcon, BookOpenIcon, Bars3Icon, XMarkIcon, ChevronLeftIcon, ChevronRightIcon, MoonIcon, SunIcon, BellIcon, CogIcon, ArrowRightOnRectangleIcon, } from '@/plugins/heroicons';
...
// @ts-ignore
[isCollapsed,];
for (const [item] of __VLS_getVForSourceType((__VLS_ctx.userMenu))) {
    // @ts-ignore
    [userMenu,];
    ...
    // @ts-ignore
    [isMobile, isCollapsed, handleMenuClick,];
