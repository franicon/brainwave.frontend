...
import { useAdminBlogsStore } from '@/stores/adminBlogs';
...
const openModal = async () => {
    ...
    const quillContainer = document.querySelector('.quill-editor .ql-editor');
    if (quillContainer) {
...
(__VLS_ctx.adminBlogsStore.totalBlogs);
(__VLS_ctx.authStore.isSuperAdmin ? `(${__VLS_ctx.adminStore.totalBlogs})` : '');
// @ts-ignore
[adminBlogsStore, authStore, adminStore,];
__VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
...
__VLS_asFunctionalElement(__VLS_elements.button, __VLS_elements.button)({
    ...
    disabled: (__VLS_ctx.adminBlogsStore.loading),
    ...{ class: "btn-3d" },
});
// @ts-ignore
[adminBlogsStore, applyFilters,];
(__VLS_ctx.adminBlogsStore.loading ? 'Searching...' : 'Apply Filters');
// @ts-ignore
[adminBlogsStore,];
__VLS_asFunctionalElement(__VLS_elements.button, __VLS_elements.button)({
    ...{ onClick: (__VLS_ctx.refreshBlogs) },
    ...{ class: "btn-3d" },
});
// @ts-ignore
[refreshBlogs,];
...
if (__VLS_ctx.adminBlogsStore.loading) {
    // @ts-ignore
    [adminBlogsStore,];
    __VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
...
else if (__VLS_ctx.adminBlogsStore.blogs.length > 0) {
    // @ts-ignore
    [adminBlogsStore,];
    __VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
    ...
    for (const [blog] of __VLS_getVForSourceType((__VLS_ctx.adminBlogsStore.blogs))) {
        // @ts-ignore
        [adminBlogsStore,];
        __VLS_asFunctionalElement(__VLS_elements.tr, __VLS_elements.tr)({
            key: (blog.id),
        ...
        (__VLS_ctx.stripHtml(blog.body).substring(0, 100));
        // @ts-ignore
        [stripHtml,];
        __VLS_asFunctionalElement(__VLS_elements.td, __VLS_elements.td)({
            ...{ class: "px-4 py-4 whitespace-nowrap" },
        ...
        __VLS_asFunctionalElement(__VLS_elements.button, __VLS_elements.button)({
            ...{ onClick: (...[$event]) => {
                    if (!!(__VLS_ctx.adminBlogsStore.loading))
                        return;
                    if (!(__VLS_ctx.adminBlogsStore.blogs.length > 0))
                        return;
                    __VLS_ctx.editBlog(blog);
                    // @ts-ignore
                    [editBlog,];
                } },
        ...
        __VLS_asFunctionalElement(__VLS_elements.button, __VLS_elements.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    if (!(__VLS_ctx.adminBlogsStore.blogs.length > 0))
                        return;
                    __VLS_ctx.confirmDelete(blog.id);
                    // @ts-ignore
                    [confirmDelete,];
                } },
...
if (__VLS_ctx.adminBlogsStore.lastPage > 1) {
    // @ts-ignore
    [adminBlogsStore,];
    __VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
    ...
    __VLS_asFunctionalElement(__VLS_elements.button, __VLS_elements.button)({
        ...{ onClick: (__VLS_ctx.adminBlogsStore.prevPage) },
        disabled: (__VLS_ctx.adminBlogsStore.currentPage === 1 || __VLS_ctx.adminBlogsStore.loading),
        ...{ class: "btn-secondary px-4 py-2" },
    });
    // @ts-ignore
    [adminBlogsStore, adminBlogsStore, adminBlogsStore,];
    __VLS_asFunctionalElement(__VLS_elements.span, __VLS_elements.span)({
        ...{ class: "px-3 py-1 text-sm font-medium text-neutral-900 dark:text-white" },
    });
    (__VLS_ctx.adminBlogsStore.currentPage);
    (__VLS_ctx.adminBlogsStore.lastPage);
    // @ts-ignore
    [adminBlogsStore, adminBlogsStore,];
    __VLS_asFunctionalElement(__VLS_elements.button, __VLS_elements.button)({
        ...{ onClick: (__VLS_ctx.adminBlogsStore.nextPage) },
        disabled: (__VLS_ctx.adminBlogsStore.currentPage === __VLS_ctx.adminBlogsStore.lastPage || __VLS_ctx.adminBlogsStore.loading),
        ...{ class: "btn-secondary px-4 py-2" },
    });
    // @ts-ignore
    [adminBlogsStore, adminBlogsStore, adminBlogsStore, adminBlogsStore,];
}
if (__VLS_ctx.showModal) {
    ...
    (__VLS_ctx.isEdit ? 'Edit Blog' : 'Create Blog');
    // @ts-ignore
    [isEdit,];
    ...
    if (__VLS_ctx.form.imagePreview) {
        // @ts-ignore
        [form,];
        __VLS_asFunctionalElement(__VLS_elements.div, __VLS_elements.div)({
            ...{ class: "mt-2" },
        ...
        __VLS_asFunctionalElement(__VLS_elements.img)({
            src: (__VLS_ctx.form.imagePreview),
            alt: "Preview",
    ...
    // @ts-ignore
    [loading,];
    (__VLS_ctx.loading ? (__VLS_ctx.isEdit ? 'Updating...' : 'Creating...') : (__VLS_ctx.isEdit ? 'Update Blog' : 'Create Blog'));
    // @ts-ignore
